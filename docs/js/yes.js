...
$(document).ready(function () {
    ...
    if (mode_custom == 'auto') {
        ...
        if (!sessionStorage.getItem('mode')) {
            ...
            if (isDark) {
                $("link[href='/css/custom.css']").before(darkHTML);
                $('.hero-img-home').find('img').attr('src', '/images/dark.jpg');
                $('.hero-img-home').find('img').attr('data-src', '/images/dark.jpg');
                $(".sun").hide();
                $(".moon").show();
                sessionStorage.setItem('mode', 'dark');
            } else {
                $('.hero-img-home').find('img').attr('src', '/images/light.jpg');
                $('.hero-img-home').find('img').attr('data-src', '/images/light.jpg');
                sessionStorage.setItem('mode', 'light');
            }
        } else {
            //todo revisit this on incognito
            if (sessionStorage.getItem('mode') == 'dark') {
                $(".sun").hide();
                $(".moon").show();
            }
